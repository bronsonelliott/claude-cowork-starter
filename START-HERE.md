...
Launch the Claude desktop app, enter Cowork mode, and select this folder when prompted.

> **Important:** select THIS folder — never one of the subfolders inside it.

### 3. Run the setup interview

Open `prompts/01-setup-interview.md`, copy the prompt inside, and paste it into Claude. It will interview you for about 15 minutes and fill out your context files.
...
├── context/                ← who you are, your voice, your preferences
